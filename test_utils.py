...
def test_logger_initialization():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"  OK Logger initialized at {run_dir}")
...
def test_logger_checkpoint():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("  OK Checkpoint saving works")
...
def test_data_manager_cifar10():
    ...
    try:
        train_loader, test_loader = DataManager.get_cifar10(batch_size=32, download=False)
        ...
        print("  OK CIFAR-10 loading works")
    except Exception as e:
        print(f"  WARN CIFAR-10 test skipped: {str(e)}")
...
def test_data_manager_cifar100():
    ...
    try:
        train_loader, test_loader = DataManager.get_cifar100(batch_size=32, download=False)
        
        assert train_loader is not None
        assert test_loader is not None
        
        print("  OK CIFAR-100 loading works")
    except Exception as e:
        print(f"  WARN CIFAR-100 test skipped: {str(e)}")
...
def test_logger_cycle_result():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("  OK Cycle result logging works")
...
def test_logger_surrogate_prediction():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("  OK Surrogate prediction logging works")
