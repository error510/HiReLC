...
def test_compression_goal():
    ...
    print("OK CompressionGoal: PASSED")
...
def test_experiment_config():
    ...
    print("OK ExperimentConfig: PASSED")
...
def test_config_constraints():
    ...
    print("OK Config Constraints: PASSED")
